...
export default function Form({stores}: {stores: Store[]}) {
    ...
    const createNotificationWithId = createNotification.bind(null, selectedstoreId);
    const [errorMessage, formAction, isPending] = useActionState(
        createNotificationWithId, undefined
    );
    ...
    <div className="max-w-xl mx-auto p-4">
        <h1 className="text-2xl font-bold mb-4 text-center">マイページ作成</h1>
